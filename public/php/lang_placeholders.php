...
$translations = [
    "en" => [
        ...
        "settings.autofetch" => "Don't automatically fetch location",
        "settings.autofetch.desc" => "Disables automatic fetching of location data for images. Reduces the number of requests to Unsplash",
        "settings.filter-non-geo" => "Filter without location data",
        "settings.filter-non-geo.desc" => "Filters out images that do not have location data",
        ...
        "settings.embed-gmaps.desc" => "Shows google maps links in an embedded map instead of link",
        ...
        "settings.highlight-tags.desc" => "Highlights tags found in previous searches from unsplash",
        ...
        "location.no-data" => "Photo has no location data, filtered out"
    ],
    "sv" => [
        "sitename" => "FotoSökGeo",
        ...
        "settings.autofetch.desc" => "Avaktiverar automatisk hämtning av platsdata för bilder. Minskar antalet hämtningar från Unsplash",
        ...
        "settings.translate-non-latin.desc" => "Översätter icke-latinska tecken i platsnamn",
        ...
        "img.metadata.camera-name" => "Kameranamn",
        "img.metadata.camera-make" => "Kameratillverkare",
        "img.metadata.camera-model" => "Kameramodell",
        "img.metadata.exposure-time" => "Exponeringstid",
        "img.metadata.aperture" => "Bländaröppning",
